...
const ButtonBody: FC<ButtonBodyProps> = ({children, hasIcon, className})=>{
    return (
        <div className="cursor-pointer flex-none w-auto h-full">
            <div className={cn("flex items-center justify-center gap-2 rounded-full bg-primary-background text-primary-foreground select-none whitespace-nowrap font-medium hover:bg-white/[0.1] transition-colors duration-300",
                className,
