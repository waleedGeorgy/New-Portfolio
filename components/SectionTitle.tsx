...
const SectionTitle: FC<SectionTitleProps> = ({number, title, icon}) => {
    return (
        <div className="relative my-10 px-8 z-10">
            {/* Section number */}
            <div className="outline-none flex flex-col justify-start shrink-0 opacity-[0.2] transform -top-32 2xl:-top-24 w-[71px] flex-none h-auto left-4 lg:left-12 absolute whitespace-pre">
            ...
            <div className="flex items-center flex-nowrap min-h-min overflow-hidden p-0 w-full font-homenaje">
                <p className="text-[17vw] lg:text-[12vw] leading-[100%] text-primary-foreground mr-3">{title}</p>
                <p className="text-[16vw] lg:text-[11vw] leading-[100%] text-primary-foreground italic">{icon}</p>
            </div>
