...
const SpecialButton: FC<SpecialButtonProps> = ({ text, icon, link }) => {
    return (
        <Link className="special-btn" href={link!}>
            <div className="group md:bg-[rgb(12,29,37)] bg-[rgb(21,21,21)] hover:bg-transparent text-primary-foreground hover:text-black rounded-full py-2 px-7 flex items-center gap-2.5 cursor-pointer transition-all duration-200 ease-in-out">
