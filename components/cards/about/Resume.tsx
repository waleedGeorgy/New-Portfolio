...
export default function Resume() {
    return (
        <Card title="Resumé" className="flex flex-col justify-center">
            ...
            <Link href="https://drive.google.com/file/d/1LpYv73t9cNIUNArugkt-n0Azwb-XrXmy/view?usp=sharing" target="_blank" download className="ml-auto animate-wiggle">
                <Button className="bg-blue-cosmos border border-gray-600/50 text-gray-200 shadow-md shadow-black/50 hover:scale-110 transition-all duration-300 hover:shadow-lg hover:shadow-black/25">
                    <FaFileDownload />
                    <span>Resume</span>
                </Button>
            </Link>
