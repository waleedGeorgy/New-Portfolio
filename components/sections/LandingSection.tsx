...
export default function LandingArea(){
    return(
        <div className="relative h-screen overflow-hidden p-8" id="landing">
            ...
            <MagneticEffect className="md:hidden [@media(max-height:565px)]:hidden absolute z-10 bottom-[4.5rem] left-0 right-0 mx-auto w-fit">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 xs:mt-0 mt-5 h-[20rem]">
                {/* Main Text */}
                <div className="text-left flex flex-col justify-center text-primary-foreground text-[5rem] xs:text-[15vw] md:text-[13vw] lg:text-[12vw] 2xl:text-[10rem] leading-[3.75rem] xs:leading-[11.5vw] md:leading-[10vw] lg:leading-[9vw] 2xl:leading-[7.5rem] uppercase [@media(max-height:565px)]:mt-9 [@media(max-height:565px)]:scale-[0.65]">
                    <div>
            ...
            {/* Current local time */}
            <div className="absolute bottom-8 md:left-10 left-[calc(50%-75px)] [@media(max-height:420px)]:scale-75 [@media(max-height:420px)]:bottom-2">
